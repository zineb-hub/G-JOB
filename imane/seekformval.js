...
let Domaine = document.querySelector('#drop-down');//separate function to be called inside checkinputs
let JobPosition = document.querySelector('#job-pos');
let Salary = document.querySelector('#salary-prop');
let JobSpec = document.querySelector('#additions'); //textarea

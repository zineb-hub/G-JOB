...
$sql = "SELECT 
            comments_post_prov.comment_content AS `comment`,
        ...
        FROM comments_post_prov
        INNER JOIN users ON users.id_user = comments_post_prov.id_user
        WHERE comments_post_prov.id_post = ?
        ORDER BY comments_post_prov.timestamp DESC";  // Added ORDER BY clause

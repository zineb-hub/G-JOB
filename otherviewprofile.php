...
{
	$name = $_POST['Subject'];
	$search = "SELECT * FROM users WHERE users.Full_Name=?";
	$stm = $connect->prepare($search);
	$stm->bind_param('s', $name); 
	$stm->execute();
	$result89 = $stm->get_result();
	$user89 = $result89->fetch_object();
	$userID = $user89->id_user;
}
...
<head>
	...
	<script src="rosey/js/prof.js"></script>
</head>
		...
		<div id="about" class="show">
			<div class="about-page">
				...
				<div class="about-content">
					...
					echo "<br><br>"
						?>
					<button onclick="download(<?php $cv ?>)" class="expand-post relativetopost"

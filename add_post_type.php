            ...
            <div class="metafooter">
                <div class="wrapfooter">
                    <span class="meta-footer-thumb">
                        <a href="profile.php" onclick="setUserIdCookie('.$id_user.')" style="cursor: pointer;">
                        <img
                            class="author-thumb"
                            src='.$profile_pic.'
                            alt="'.$Name.'"
                    ...
                    <span class="author-meta" href="profile.php" onclick="setUserIdCookie('.$id_user.')" style="cursor: pointer;">
                    <span class="post-name"><a target="_blank" href="profile.php">'.$Name.'</a></span><br />
                    <span class="post-date">'.$date.'</span>
                    </span>
                    <span class="post-read-more">
                        <a
                            href="profile.php" onclick="setUserIdCookie('.$id_user.')" style="cursor: pointer;"
                            title="Read Story"
                            ><i
                                class="fa fa-link"
                            ></i

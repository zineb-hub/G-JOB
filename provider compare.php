...
================================================== -->
    ...
    ================================================== -->
	        <section class="intro">
				<div class="wrapintro">
					<h1>G-Jobs</h1>
					<h2 class="lead">Provide a job!</h2>
					<a href="provform.php" class="btn">Offer a Job</a>
				</div>
			</section>
...
$(document).ready(function(){
    // Assuming setTypeSession and fetch_posts are defined elsewhere
    setTypeSession('provider');
    fetch_posts();
	add_featured_posts();
